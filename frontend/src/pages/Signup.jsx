                    ...
                    <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
                        ...
                        <form className="mt-6">
                            ...
                            <div className="mt-4 flex items-center text-gray-500">
                                ...
                                <label className="text-sm" for="remember"><p className='text-black'>I agree with the <a className="text-indigo-400 hover:text-indigo-500">Privacy Policy</a></p> </label></div>
