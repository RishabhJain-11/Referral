            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10">
                {
                    jobs && jobs.map((job) => (
                        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-2">
                            ...
                            <p >
                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-[#38bdf8] underline hover:underline-offset-4 hover:text-[#f43f5e]">{job.compName}</h5>
                            </p>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Role : {job.type}</p>

                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Salary : {job.jobSalary}</p>

                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Experience : {job.exp}</p>

                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400"> Location : {job.location}</p>

                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400"> Employee Count : {job.empCount}</p>

                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Role : {job.role}</p>

                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Industry : {job.industry}</p>

                            <a href={job.link} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" target="_blank" rel="noreferrer">
                                Apply Now
